...
<div align="center">
    <div class="col-lg-12" >
        ...
        <h1>Tabel Tunjangan</h1>
            <div class="panel-heading">
            <a href="<?php echo e(route('tunjangan.create')); ?>" class="btn btn-primary">Tambah Data</a>
                        ...
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $tunjangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td align="right">
                                    <a href="<?php echo e(route('tunjangan.edit', $data->id)); ?>" class="btn btn-primary">Edit</a>
                                </td>
